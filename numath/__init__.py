...
__all__ = [
    ...
    'trapezoidal_rule', 'simpson_rule', 'simpson_38_rule', 'n4_close_rule', 'midpoint_rule', 'n1_open_rule', 'n2_open_rule', 'n3_open_rule', 'composite_simpson_rule', 'composite_trapezoidal_rule', 'composite_midpoint_rule'
]