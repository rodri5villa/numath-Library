...
from .diferenciacion_numerica_e_integracion import derivative_three_points_central, derivative_five_points_central, derivative_three_points_border, derivative_five_points_border, derivative_unified
...
__all__ = [
    ...
    'derivative_three_points_central', 'derivative_five_points_central', 'derivative_three_points_border', 'derivative_five_points_border', 'derivative_unified'
]